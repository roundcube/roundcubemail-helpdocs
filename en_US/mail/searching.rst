...
Then enter the search term into the search box above the messages list and press <Enter> on your keyboard to start the search.
Search results will be displayed in the messages list.
...
You can also type specific search criteria directly into the bar, such as "from:Scott" or "subject:Conference."
...
The drop-down menu next to the search box offers some pre-defined filters for quickly
