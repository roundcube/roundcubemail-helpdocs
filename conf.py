# -*- coding: utf-8 -*-
#
# Roundcube Webmail Help documentation build configuration file, created by
...
project = u'Roundcube Webmail Help'
copyright = u'2013, roundcube.net'
...
htmlhelp_basename = 'RoundcubeWebmailHelpdoc'
